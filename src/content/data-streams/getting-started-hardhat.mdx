...
| `PRIVATE_KEY` | The private key of the account that will deploy the contracts. You can use the private key of your MetaMask wallet. You can find the private key in MetaMask by clicking the three dots next to your account and selecting "Account details". Then click "Export private key". |

## Deploy the Chainlink Automation upkeep and the Log Emitter contracts
